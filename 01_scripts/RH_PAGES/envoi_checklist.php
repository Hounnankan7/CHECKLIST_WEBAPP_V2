<?php
    ...
    if($form_data ){
        ...
        if($task_data){
            ...
            $outputFilePath = __DIR__ .'/00_PDF_CHECKLIST/CHECKLIST_'.$employe_nom.'_'.$employe_prenom.'.pdf';
            ...
            // Chemin du fichier de configuration
                ...
                try {
                    ...
                    header('location: ../../01_scripts/RH_PAGES/rh_add_checklist.php?send_checklist=success');

                } catch (Exception $e) {
                    echo "Erreur : {$mail->ErrorInfo}<br>";
                    header('location: ../../01_scripts/RH_PAGES/rh_add_checklist.php?send_checklist=error&message=Erreur: {'.$mail->ErrorInfo.'}<br>');
                }
        }else {
