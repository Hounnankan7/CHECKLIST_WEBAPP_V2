            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="admin_cleanup.php"><i class="fa-solid fa-broom fa-xl"></i> Nettoyage Auto</a></li>
        ...
        <?php
            ...
            if (strcasecmp($deleteEntry_query_state, "success") === 0) {
                echo '<div class="alert alert-success" style="width:674px;margin-left:16px;" role="alert">';
                    ...
                    echo '<a class="closer_alert" href="../../01_scripts/ADMIN_PAGES/admin_homepage.php" style="float:right;"><i class="fa-solid fa-x"></i></a>';
                echo '</div>';
        ...
        <section>
            ...
            <table class="table table-hover">
                ...
                <?php
                    ...
                    $found_tasks=mysqli_query($database_connect, "SELECT t.*, e.user_lastname, e.user_firstname, e.date_embauche FROM tasks_table t INNER JOIN new_employee_table e ON t.id_employe = e.id_employe WHERE t.progression < 100 AND t.etat_rh = 'Valide' ORDER BY e.date_embauche DESC LIMIT $start, $parPage");
                    while ($row= $found_tasks-> fetch_assoc()) {
                        ...
                        echo '<tr style="height: 70%;">';
                            ...
                            echo "<td style='text-align: center;'> <a style='color:#EF7837;' href='../oneProfil_tasks.php?id_profil=$employeId&role=informaticien'>Modifier</a> </td>";
                        echo '</tr>';
                    }
                ?>
