            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="http://192.168.4.164:81/phpMyAdmin/db_structure.php?server=1&db=checklist_dbv2" target="_blank"><i class="fa-solid fa-database fa-xl"></i>Administration BDD</a></li>
        ...
        <section>
            ...
            <table class="table table-hover">
                ...
                <?php
                    ...
                    $found_tasks=mysqli_query($database_connect, "SELECT t.*, e.user_lastname, e.user_firstname, e.date_embauche FROM tasks_table t INNER JOIN new_employee_table e ON t.id_employe = e.id_employe WHERE t.progression >= 100 ORDER BY e.date_embauche DESC LIMIT $start, $parPage");
