<?php
    ...
    if($deletechecklist_task){
        header('location: ../../01_scripts/ADMIN_PAGES/admin_homepage.php?delete_EntryState=success');
    }else{
        header('location: ../../01_scripts/ADMIN_PAGES/admin_homepage.php?delete_EntryState=fail');
    }
