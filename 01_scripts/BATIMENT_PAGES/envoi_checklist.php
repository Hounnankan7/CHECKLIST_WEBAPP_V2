        ...
        if($task_data){
            ...
            // Chemin du fichier de configuration
                ...
                try {
                    ...
                    header('location: ../../01_scripts/BATIMENT_PAGES/batiment_add_checklist.php?send_checklist=success');

                } catch (Exception $e) {
                    echo "Erreur : {$mail->ErrorInfo}<br>";
                    header('location: ../../01_scripts/BATIMENT_PAGES/batiment_add_checklist.php?send_checklist=error&message=Erreur: {'.$mail->ErrorInfo.'}<br>');
                }
        }else {
