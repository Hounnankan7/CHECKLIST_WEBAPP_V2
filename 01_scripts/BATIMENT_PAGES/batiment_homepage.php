        ...
        <table class="table table-hover">
            ...
            <?php
                ...
                $found_tasks=mysqli_query($database_connect, "SELECT t.*, e.user_lastname, e.user_firstname, e.date_embauche 
                    FROM tasks_table t INNER JOIN new_employee_table e ON t.id_employe = e.id_employe WHERE t.progression < 100 AND t.etat_rh = 'Valide'
                ...
                while ($row= $found_tasks-> fetch_assoc()) {
                    ...
                    echo '<tr style="height: 80%;">';
                        ...
                        echo "<td style='text-align: center;'> <a style='color:#EF7837;' href='../oneProfil_tasks.php?id_profil=$employeId&role=batiment'>Modifier</a> </td>";
