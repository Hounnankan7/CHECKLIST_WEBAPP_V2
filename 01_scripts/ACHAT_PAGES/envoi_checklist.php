        ...
        $employe_arrive_date2 = date('d-m-Y', strtotime($_POST['arrive_date']));
            ...
            // Chemin du fichier de configuration
                ...
                try {
                    ...
                    header('location: ../../01_scripts/ACHAT_PAGES/achat_add_checklist.php?send_checklist=success');

                } catch (Exception $e) {
                    echo "Erreur : {$mail->ErrorInfo}<br>";
                    header('location: ../../01_scripts/ACHAT_PAGES/achat_add_checklist.php?send_checklist=error&message=Erreur: {'.$mail->ErrorInfo.'}<br>');
                }
        }else {
...
$state = isset($form_data) && $form_data ? 'success' : 'failed';
