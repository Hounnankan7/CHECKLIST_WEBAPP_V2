...
<html lang="fr">
    <head>
        ...
        <title>SUIVI CHECK LIST - RESPONSABLE ACHATS</title>
        ...
        <table class="table table-hover">
            ...
            <?php
                ...
                while ($row= $found_tasks-> fetch_assoc()) {
                    ...
                    $date_embauche = new DateTime($date_emb);
                    ...
                    echo '<tr style="height: 80%;">';
                        ...
                        echo "<td style='text-align: center;'> <a style='color:#EF7837;' href='../oneProfil_tasks.php?id_profil=$employeId&role=achat'>Modifier</a> </td>";
